...
//         const nameLabelElement =
//             fixture.nativeElement.querySelector('.name-label');
...
//             fixture.nativeElement.querySelector('.image-container');
//         expect(imageContainerElement.style.backgroundColor).toBe(
//             proyecto.color
//         );
//     });

//     it('should open dropdown menu when options button is clicked', () => {
//         const optionsButtonElement =
//             fixture.nativeElement.querySelector('.options-button');
//         optionsButtonElement.click();
//         fixture.detectChanges();
//         const dropdownMenuElement =
//             fixture.nativeElement.querySelector('.ant-dropdown-menu');
