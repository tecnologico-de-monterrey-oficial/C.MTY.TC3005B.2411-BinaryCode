...
export class ArchivosService {
    ...
    archivos: Archivo[] = [
        ...
        new Archivo("4",false, fileIcons.solidWorks, 'Archivo 4', new Usuario("34", 'assets/images/usuarios_props/anya.png', 'Angel Garcia'), [new Etiqueta("24", 'Etiqueta 10', tarjeta_verde_fuerte), new Etiqueta("21", 'Etiqueta 11', tarjeta_azul_fuerte), new Etiqueta("21", 'Etiqueta 12', tarjeta_morado_claro), new Etiqueta("21", 'Etiqueta 9', tarjeta_rosa)], '29 de febrero de 2024'),
        ...
        new Archivo("6",false, fileIcons.image, 'Archivo 6', new Usuario("36", 'assets/images/usuarios_props/corrin.png', 'Presno Gonzalez'), [new Etiqueta("26", 'Etiqueta 16', tarjeta_amarillo_fuerte), new Etiqueta("21", 'Etiqueta 17', tarjeta_azul_medio), new Etiqueta("21", 'Etiqueta 18', tarjeta_verde_claro)], '29 de febrero de 2024'),
        ];
