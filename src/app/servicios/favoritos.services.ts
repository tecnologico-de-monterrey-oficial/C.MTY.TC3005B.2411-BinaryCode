...
export class FavoritosServices {
  ...
  archivos: Archivo[] = [
    ...
    new Archivo("19",true, fileIcons.image, 'Archivo 19', new Usuario("36", 'assets/images/usuarios_props/corrin.png', 'Presno Gonzalez'), [new Etiqueta("26", 'Etiqueta 16', tarjeta_amarillo_fuerte), new Etiqueta("21", 'Etiqueta 17', tarjeta_azul_medio), new Etiqueta("21", 'Etiqueta 18', tarjeta_verde_claro)], '29 de febrero de 2024'),
  ];
